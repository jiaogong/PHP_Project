<?php
/**
 * Memcached extension class, not Memcache extension
 * $Id: mmcached.class.php 2930 2016-06-06 07:08:31Z david $
 * @author David Shaw <tudibao@163.com>
 */

class mmcached extends Memcached{
    private $cache_list_name = "cache_list_name_srv";
    private $timestamp;

    function mmcached($mm) {
        parent::__construct();
        $this->addServer($mm['host'], $mm['port']) || die('cant connect memcached server!');
