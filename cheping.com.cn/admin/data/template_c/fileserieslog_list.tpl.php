...
<div class="user">
    <div class="nav">
        <ul id="nav">
              ...
              <li><a href="<?=$php_self?>fileserieslist" class="song">车系日志</a></li>
                    ...
                    <tr>
                        <td>
                         ...
                         <select name="file_state" id="file_state">
                            ...
                            <option value="1" <? if ($file_state==1) { ?>selected<? } ?>>修改品牌</option>
                            <option value="2"  <? if ($file_state==2) { ?>selected<? } ?>>修改厂商</option> 
                            <option value="3" <? if ($file_state==3) { ?>selected<? } ?>>修改车系</option> 
                          </select>
                         提交时间
