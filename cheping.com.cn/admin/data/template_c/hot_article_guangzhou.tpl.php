...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?=$php_self?>bannerwenhua" >文化轮播图</a></li>
                    <li><a href="<?=$php_self?>bannerguangzhou">广州车展轮播图</a></li>
                    <li><a href="<?=$php_self?>hotarticleguangzhou"  class="song">广州车展热门文章</a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody id="tobdy">
                            ...
                            <tr>
                                ...
                                <td style="width:150px;"><input type="text" class="title" name="title[]" value="<?=$v[title]?>"></td>
        ...
        <script type="text/javascript">
            ...
            function add(){
                var html ='<tr><td><input class="id_a" type="text" value=""  name="id[]" size="4" ></td> <td style="width:150px;" class="content1"><input type="text" name="title[]" value=""></td><td class="content2"><input type="text" name="url[]" value=""></td><td class="content3"></td><td></td><td><input type="text" name="orderby[]" size="4" value=""></td><td><span><input type="button" value="确认" class="but_check"><a href="javascript:void(0)" class="but_del">移除</a></span></td></tr>';
                $("#tobdy").prepend(html);
            }
