...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul id="nav">
                    <li><a href="<?=$php_self?>bannerindex&a=0" <? if ($a == 0) { ?>class="song"<? } ?>>首页轮播图</a></li> 
                    <li><a href="<?=$php_self?>bannerindex&a=1" <? if ($a == 1) { ?>class="song"<? } ?>>新闻轮播图</a></li> 
                    <li><a href="<?=$php_self?>bannerindex&a=2" <? if ($a == 2) { ?>class="song"<? } ?>>评测轮播图</a></li> 
                    <li><a href="<?=$php_self?>bannerindex&a=3" <? if ($a == 3) { ?>class="song"<? } ?>>视频轮播图</a></li> 
                    <li><a href="<?=$php_self?>bannerindex&a=4" <? if ($a == 4) { ?>class="song"<? } ?>>文化轮播图</a></li> 
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
                <div class="user-table">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody id="tobdy">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><a class="jTip" id="jtip<?=$k?>" href="/admin/index.php?action=index-pic&picture=<?=$v[pic]?>">查看图片(750*254)</a></p></td>
                        ...
                        <div style="padding:6px 0px; width:98%; border-bottom: 1px solid #ccc; margin:0 auto;">
                                    <input type="button" class="sbt"style=" padding:0px 4px; margin-left:100px; color:#333;font-family:'微软雅黑';  " <? if ($a==0) { ?>onclick="make('wap_index')"<? } elseif($a==2) { ?>onclick="make('wap_pingce')"<? } elseif($a==3) { ?>onclick="make('wap_video')"<? } elseif($a==4) { ?>onclick="make('wap_wenhua')<? } elseif($a==1 ) { ?>onclick="make('wap_new')"<? } ?>" value="生成"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
