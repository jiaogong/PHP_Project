        ...
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a  style="width: 200px;" href="<?=$php_self?>typelist" class="song">审核意见待处理文章列表</a></li>
            ...
            <div class="user-con">
              <div style=" padding:20px 5px; width：98%; border-bottom:1px solid #ccc; ">
                    <form id="search_form" name="search_form" method="post" action="index.php?action=article-typelist">
                ...
                <div class="user-table">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>                                                   
                            ...
                            <td style=" padding-top:20px;">副标题</td>
                            <td style=" padding-top:20px;width:40px;">频道</td>
                            <td style=" padding-top:20px;">作者</td>
                            <td style=" padding-top:20px;">上线时间</td>
                            <td style=" padding-top:20px;">时间</td>
                            <td style=" padding-top:20px;width:100px;">字数</td>
                            <td style=" padding-top:20px;width:130px;">操作</td>
                        </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span><i style=" padding-top:2px;"><img src="images/shanchu.png" /></i><a  href="<?=$php_self?>del&id=<?=$v['id']?>&type=3" onclick="return confirmDel('确定要删除吗')"  >删除</a></span>
                                    <span><i style=" padding-top:3px;"><img src="images/bi.png" /></i><a href="<?=$php_self?>edit&id=<?=$v[id]?>&type=1&a=1">修改信息</a> <a href="<?=$php_self?>preview&id=<?=$v[id]?>&s=1" target="_blank">预览</a></span>
                                </td>
                            </tr>
                            <?}?>
                        </tbody>
