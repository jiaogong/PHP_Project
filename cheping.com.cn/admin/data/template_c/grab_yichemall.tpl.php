...
<div class="user">
    <div class="nav">
        <ul id="nav">
            <li><a href="index.php?action=grabyiche" class="song">抓取易车商城数据</a></li>
                ...
                <tr>
                    <td>
                        ...
                        <input type="button" name="bn" id="bn" value="开始抓取">
                         <br><div style="text-align: left; padding-left: 124px;">例：http://www.yichemall.com/car/list?&pricebegin=1&priceend=5000</div>
                    </td>
                </tr>
            </table>
...
<script type="text/javascript">
    $('#bn').click(function() {
        ...
        var grab_url = "?action=grabyiche-grabmall&url="+escape(yiche_url);
