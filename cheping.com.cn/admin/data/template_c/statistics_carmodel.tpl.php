...
<div class="user">
    <div class="nav">
        ...
        <li><a href="<?=$php_self?>carmodel" class="song">车型</a></li>
    ...
    <div class="user_con">
        <div class="user_con1" style="margin-top:20px;margin-left:40px;">
            ...
            <table class="table2" border="0" cellpadding="0" cellspacing="0">
                <tr style="color:red;">
                    <th colspan="4" style="text-align: left;line-height:26px;"><h3>共有正常状态车系中的车型数(<?=$total?>)</h3></th>
                </tr>
                ...
                <tr class='th'>
                    <td height="30" style="text-align:left;" nowrap><?=$key?>中的<?=$kk?></td>
                    <td width="40%" style="text-align:left;"><font style="color:red;"><?=$kk?></font><font style="color:blue;"><?=$k?></font></td>
                    <td width="15%"><strong style="color:red;"><?=$v[total]?></strong></td>
                    <td width="15%"><a href="<?=$php_self?>carmodeldetail&state=<?=$v[state]?>">查看详细</a></td>
                </tr>
                 <?}?>
                 <?}?>
                <?}?>
