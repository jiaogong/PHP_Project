...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    <li><a href="<?=$php_self?>evalu" class="song">专业测评列表</a></li> 
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
                <div class="user-table">
                    <form action="" method="post">
                     ...
                     <span style="float: left;margin-left:200px;"><input type="button" class="sbt" style=" padding:0px 4px;  color:#333;font-family:'微软雅黑';  " onclick='add()' value="添加"/>  &nbsp;&nbsp;添加文章和视频id，点击确认</span>
                                    <input type="button" class="sbt" style=" padding:0px 4px; margin-left:100px; color:#333; font-family:'微软雅黑';  " onclick="make('evalu')" value="生成"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td style="width:100px;"><input type='text' value="<?=$v[id]?>" id="<?=$v[id]?>" name="id[]" size="4" readonly="readonly"></td>
                                ...
                                <td>
                                    <input type='text' value="<?=$v[orderby]?>" placeholder="默认" class="sort_article" style="width:50px;text-align:center;" name="orderby[]" size="4">
                                </td>
                                <td>
                                    <span>
        ...
        <script type="text/javascript">
            ...
            function add(){
                var html ='<tr><td><input class="id_a" type="text" value=""  name="id[]" size="4" ></td><td class="content1" width="200"></td><td class="content2"></td><td class="content3"></td><td><input type="text" placeholder="默认" style="width:50px;text-align:center;" name="orderby[]" size="4" value=""></td><td><span><input type="button" value="确认" class="but_check"><a href="javascript:void(0)" class="but_del">移除</a></span></td></tr>';
                $("#tobdy").prepend(html);
            }
