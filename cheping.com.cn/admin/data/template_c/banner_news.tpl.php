...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?=$php_self?>bannernews" class="song">新闻轮播图</a></li> 
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div style="padding:6px 0px; width:98%; border-bottom: 1px solid #ccc; margin:0 auto;">
                            <span style="float: left; margin-left:200px;"><input type="button" class="sbt" onclick='add()'style=" padding:0px 4px;  color:#333;font-family:'微软雅黑';  " value="添加"/>添加文章和视频id，点击确认或直接添加内容</span>
                                    ...
                                    <input type="button" class="sbt"style=" padding:0px 4px; margin-left:100px; color:#333;font-family:'微软雅黑';  " onclick="make('banner_news')" value="生成"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <script type="text/javascript">
            ...
            function make(i) {
                 $.get("<?=$php_self?>bannermake",{"name":i,"type":2},function(msg){
                     if(msg==1){
                         alert("生成成功");
                     }else{
                         alert("生成失败");
