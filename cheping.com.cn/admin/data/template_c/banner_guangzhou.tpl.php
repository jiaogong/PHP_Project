        ...
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?=$php_self?>bannerguangzhou" class="song">广州车展轮播图</a></li>
                    <li><a href="<?=$php_self?>hotarticleguangzhou">广州车展热门文章</a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
                <div class="user-table">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody id="tobdy">
                            ...
                            <tr>
                                <td><input type='text' class="id_a" value="<?=$v[id]?>" id="<?=$v[id]?>" name="id[]" size="4" readonly="readonly"></td>
