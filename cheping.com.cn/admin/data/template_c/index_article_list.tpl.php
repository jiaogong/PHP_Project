...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    <li><a href="<?=$php_self?>article" class="song">热门文章列表</a></li> 
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
                <div class="user-table">
                    ...
                    <form action="" method="post">
                        <div style="padding:6px 0px; width:98%; border-bottom: 1px solid #ccc; margin:0;">
                            <span style="float: left;"><input type="button" class="sbt" onclick='add()'style=" margin-left: 200px;  color:#333;font-family:'微软雅黑';  " value="添加"/>添加文章和视频id，点击确认</span>
                                    
                                    <input type="button" class="sbt"style=" padding:0px 4px; margin-left:100px; color:#333;font-family:'微软雅黑';  " onclick="make('article')" value="生成"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tbody id="tobdy">
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td><input type="text" class ="sort_article" name="orderby[]" size="4"style="width:50px;text-align:center;" placeholder="默认"  value="<?=$v[orderby]?>"></td>
                                 <td>
                                    <span>
