      ...
      <table cellpadding="0" cellspacing="0" class="table2">
            ...
            <td class="td_left">
                <select id="state" name="state">
                    <option value="1" <? if ($list['state']=='1') { ?>selected<? } ?>>无效</option>
                    <option value="2" <? if ($list['state']=='2') { ?>selected<? } ?>>有效</option>
                </select>
								<? if ($list['state']=='1') { ?>
            ...
            <td class="td_left">
				<input type="text" value="<? if ($list['src_id']) { ?>是<? } else { ?>否<? } ?>" disabled>
            </td>
          </tr>
          <tr> 
            ...
            <td class="td_left">
                <select id="province_id" name="province_id" onchange="changeProvince(this.value);">
                    ...
                    <? foreach((array)$province as $k=>$v) {?>
                        <option value="<?=$v['id']?>" <? if ($list['province_id']==$v['id']) { ?>selected="selected"<? } ?>><?=$v['letter']?> <?=$v['name']?></option>
                    <?}?>
                </select>
            </td>
          </tr>
         <tr> 
            ...
            <select id="city_id" name="city_id" onchange="changeCity(this.value);">
                ...
                <? foreach((array)$city as $k=>$v) {?>
                    <option value="<?=$v['id']?>" <? if ($list['city_id']==$v['id']) { ?>selected="selected"<? } ?>><?=$v['letter']?> <?=$v['name']?></option>
                <?}?>
            </select>
            </td>
          </tr>
         <tr> 
            ...
            <select id="county_id" name="county_id">
                ...
                <? foreach((array)$county as $k=>$v) {?>
                    <option value="<?=$v['id']?>" <? if ($list['county_id']==$v['id']) { ?>selected="selected"<? } ?>><?=$v['letter']?> <?=$v['name']?></option>
                <?}?>
            </select>
            </td>
          </tr>           
          ...
          <tr id='tr_username' <? if ($list['state']==='2') { ?>style="display:none;"<? } ?>> 
          ...
          <tr id="tr_password" <? if ($list['state']==='2') { ?>style="display:none;"<? } ?>> 
         ...
         <tr> 
            ...
            <td class="td_left">
                ...
                <a id="vpic" class="jTip" name="经销商图片" href="/admin/index.php?action=dealer-pic&dealer_id=<?=$list['dealer_id']?>&num=0">查看图片</a>&nbsp;&nbsp;&nbsp;默认标签<input type="text" name="pic_alt1" value="<? if ($list['pic_alt1']) { ?><?=$list['pic_alt1']?><? } else { ?><?=$list['dealer_name']?><? } ?>"/>
            </td>
          </tr>
          <tr> 
            <td width="100" height="20" align="right">经销商图片:</td>
            <td class="td_left">
                ...
                <a id="vpic" class="jTip" name="经销商图片" href="/admin/index.php?action=dealer-pic&dealer_id=<?=$list['dealer_id']?>&num=1">查看图片</a>&nbsp;&nbsp;&nbsp;默认标签<input type="text" name="pic_alt2" value="<? if ($list['pic_alt2']) { ?><?=$list['pic_alt2']?><? } else { ?><?=$list['dealer_name']?><? } ?>"/>
            </td>
          </tr>
            <tr> 
            <td width="100" height="20" align="right">经销商图片:</td>
            <td class="td_left">
                ...
                <a id="vpic" class="jTip" name="经销商图片" href="/admin/index.php?action=dealer-pic&dealer_id=<?=$list['dealer_id']?>&num=2">查看图片</a>&nbsp;&nbsp;&nbsp;默认标签<input type="text" name="pic_alt3" value="<? if ($list['pic_alt3']) { ?><?=$list['pic_alt3']?><? } else { ?><?=$list['dealer_name']?><? } ?>"/>
...
<!--                        <? foreach((array)$series as $k=>$v) {?>
            ...
            <table id="serviceTab" name="serviceTab">
            <? foreach((array)$service as $s=>$serv) {?>            
