                                        ...
                                        <? ++$j ?>
                                            <tr <? if ($j % 2 == 0) { ?>style="background-color:#D2D2D2;"<? } ?>>                                    
                                                <td>
                                                    ...
                                                    <? } elseif($key == 2) { ?>
                                                        <input type="text" id="alias<?=$j?>" name="alias<?=$j?>" value="<? echo $series[$j]['alias'] ?>" size="20" class="alias">                                                        
                                                    <? } else { ?>
                                                        <input type="text" id="price_id<?=$j?>" name="price_id<?=$j?>" value="<? echo $series[$j]['price_id'] ?>" size="10" class="price_id">                                                                                                                
                                                    <? } ?>
                                                </td>
                                            </tr>
                                        <? } ?>
