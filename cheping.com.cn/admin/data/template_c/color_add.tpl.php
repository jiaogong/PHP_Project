...
<div class="user_wrap">
<ul class="nav2">
    <li><a href="<?=$php_self?>colorindex">车系颜色列表</a></li>
    <li class="li1"><a href="#">新增车系颜色</a></li>
</ul>
<div class="clear"></div>
<div class="user_con">
<div class="user_con1">

<form action="<?=$php_self?>coloradd" method="post" enctype="multipart/form-data">
  <table class="table2" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td class="td_left">
      <input type="text" size="20" name="name" id="name" value="<?=$series_name?>" readOnly="true">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="td_left">
      <? foreach((array)$series_list as $key=>$value) {?>
          <img src="<?=$value['color_pic']?>" width="17" height="17" title="<?=$value['color_name']?>" style="vertical-align:middle;"/>
          <?=$value['color_name']?>
              <input type="button" value="删除" id="<?=$value['id']?>"  onclick="window.location.href='<?=$php_self?>colordel&id=<?=$value['id']?>&color_name=<?=$value['color_name']?>&type_id=<?=$value['type_id']?>'"/></br>
      <?}?>
      </td>
    </tr>
    ...
    <tr>
      ...
      <input type="hidden" name="type_id" id="id" value="<?=$series_id?>">
