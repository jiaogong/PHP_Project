        ...
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?=$php_self?>typelist" class="song">审核意见待处理视频列表</a></li>
            ...
            <div class="user-con">
                <div>
                    <form id="search_form" name="search_form" method="post" action="index.php?action=video-typelist">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span><i style=" padding-top:3px;"><img src="images/bi.png" /></i><a href="<?=$php_self?>edit&id=<?=$v[id]?>&type=1">修改信息</a> <a href="<?=$php_self?>preview&id=<?=$v[id]?>&s=1" target="_blank">预览</a></span>
                                </td>
                            </tr>
                            <?}?>
                        </tbody>
