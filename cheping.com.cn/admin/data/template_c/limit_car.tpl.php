...
<div class="user">
  <div class="nav">
    <ul id="nav">
    <li><a href="<?=$php_self?>">限时抢购</a></li>
    <li><a href="javascript:void(0);" class="song">限量抢购</a></li>
</ul>
  </div>
  <div class="clear"></div>
<div class="user_con">
    <div class="user_con1">
      ...
      <table cellpadding="0" cellspacing="0" class="table2" border="0">
        ...
        <tr>
          ...
          <td class="td_left">
              <input type="text" name="num_<?=$i?>" id="num_<?=$i?>" value="<? echo $hotcarseries[$i-1]['num']; ?>">
          </td>
        </tr>
        <tr>
          <td class="td_left blue" width="15%">
          ...
          <td class="td_left">
              <input type="text" name="dnum_<?=$i?>" id="dnum_<?=$i?>" value="<? echo $hotcarseries[$i-1]['dnum']; ?>">
          </td>
        </tr>
        <tr>
          <td class="td_left blue" width="15%">
