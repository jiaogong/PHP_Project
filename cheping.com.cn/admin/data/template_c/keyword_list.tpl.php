...
<div class="user">
    <div class="nav">
        ...
        <li><a href="<?=$php_self?>keyword"  class="song">关键字统计</a></li>
    ...
    <div class="user_con">
        <div class="user_con1" style="margin-top:20px;margin-left:40px;">
            ...
            <table class="table2" border="0" cellpadding="0" cellspacing="0">
                ...
                <? foreach((array)$value["keyword"] as $k=>$v) {?>
                <tr class='th'>
                    ...
                    <td width="15%"><a href="<?=$php_self?><?=$value['detail']?>&state=<? if ($k=='已设关键字') { ?>1<? } elseif($k=='未设关键字') { ?>2<? } ?>">查看详细</a></td>
                </tr>
                <?}?>
            </table>
