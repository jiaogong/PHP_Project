    ...
    <div class="module_con1">
      <table cellpadding="0" cellspacing="0" class="table2">
        ...
        <tr align="right">
          ...
          <td><?=$v[brand_name]?>(<? echo getCardbState2($v[bs]); ?>)</td>
          <td height="20" nowrap align="center"><?=$v[factory_name]?>(<? echo getCardbState2($v[fs]); ?>)</td>
          <td><? echo getCardbState2($v[state]); ?></td>
