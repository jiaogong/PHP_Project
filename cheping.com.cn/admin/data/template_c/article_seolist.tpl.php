        ...
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a style="width: 200px;" href="<?=$php_self?>seolist" class="song" >SEO审核列表</a></li>
            ...
            <div class="user-con">
                 <div style=" padding:20px 5px; width：98%; border-bottom:1px solid #ccc; ">
                    <form id="search_form" name="search_form" method="post" action="index.php?action=article-seolist">
                ...
                <div class="user-table">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>                                                   
                            ...
                            <td style=" padding-top:20px;width:145px;">副标题</td>
                             <td style="padding-top:20px;width:45px;">频道</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span><i style=" padding-top:2px;"><img src="images/luck.png" /></i>
                                        <a href="<?=$php_self?>preview&id=<?=$v[id]?>&seo=1" target="_blank">预览</a>
                                    </span>
                                </td>
                            </tr>
                            <?}?>
