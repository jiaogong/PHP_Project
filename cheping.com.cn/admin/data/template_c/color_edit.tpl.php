...
<ul class="nav2">
    ...
    <li class="li1"><a href="#">修改车系颜色</a></li>
</ul>
<div class="clear"></div>
<div class="user_con">
<div class="user_con1">
    
<form action="<?=$php_self?>coloredit" method="POST" enctype="multipart/form-data">
  <table class="table2" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <div id="<?=$value['id']?>">
          ...
          <input type="hidden" value="<?=$value['color_name']?>" name="rcolor_name[]"/>
