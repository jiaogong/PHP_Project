...
<div class="user">
    <div class="nav">
        ...
        <li><a href="<?=$php_self?>pic" class="song">图片关联统计</a></li>
    ...
    <div class="user_con">
        <div class="user_con1" style="margin-top:20px;margin-left:40px;">
            ...
            <table class="table2" border="0" cellpadding="0" cellspacing="0">
                <tr style="color:red;">
                    <th colspan="4" style="text-align: left;line-height:26px;"><h3>共有正常状态<?=$key?>数(<?=$value["total"]?>)</h3></th>
                </tr>
                ...
                <tr class='th'>
                    ...
                    <td width="15%"><? if ($key=="车系") { ?><a href="<?=$php_self?>seriespic&picstate=<? if ($k=='已上传车系图') { ?>1<? } elseif($k=='未上传车系图') { ?>0<? } elseif($k=='已实拍') { ?>2<? } elseif($k=='未实拍') { ?>3<? } ?>">查看详细</a><? } ?></td>
                </tr>
                <?}?>
            </table>
