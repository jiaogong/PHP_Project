...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?=$php_self?>guangzhouheadline">车展头条</a></li>
                    <li><a href="<?=$php_self?>guangzhouhotarticle"  class="song">车展热门文章</a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
        ...
        <script type="text/javascript">
            ...
            function add(){
                var html ='<tr><td style="display:none"><input class="id_a" type="text" value=""  name="id[]" size="4" ></td><td style="width:35%;"><input style="width:250px;"  type="text" name="title[]" value=""></td><td style="width:30%;"><input style="width:180px;" type="text" name="url[]" value=""></td><td><input type="text"  style="width:50px;text-align:center;" name="orderby[]" size="4" value=""></td><td style="width:10%;"><span><input type="button" value="确认" class="but_check"><a href="javascript:void(0)" class="but_del">移除</a></span></td></tr>';
                $("#tobdy").prepend(html);
            }
