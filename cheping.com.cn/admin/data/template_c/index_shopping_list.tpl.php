...
<? include $this->gettpl('header');?> 
        <div class="user">
            <div class="nav">
                <ul>
                    <li><a href="<?=$php_self?>shopping" class="song">精品导购列表</a></li> 
                </ul>
            </div>
            <div class="clear"></div>
            <div class="user-con">
        ...
        <script type="text/javascript">
            ...
            function add(){
                var html ='<tr><td><input class="id_a" type="text" value=""  name="id[]" size="4" ></td><td class="content1" width="200"></td><td class="content2"></td><td class="content3"></td><td><span><input type="button" value="确认" class="but_check"><a href="javascript:void(0)" class="but_del">移除</a></span></td></tr>';
                $("#tobdy").prepend(html);
            }
