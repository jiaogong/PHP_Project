...
<div class="x_panel">
	...
	<div class="x_content">
	    <br>
	  	<form action="<?php echo U(upload);?>" class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" name="goods_insert" novalidate="" method="post" >
				<input type="hidden" name="fid" value="<?php echo ($art["fid"]); ?>">
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">网站名称
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 500px;" class="form-control col-md-7 col-xs-12" required="required" id="fname" name="fname" data-parsley-id="4702" value="<?php echo ($art["fname"]); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 500px;"  class="form-control col-md-7 col-xs-12" required="required" id="furl" name="furl" data-parsley-id="4702" value="<?php echo ($art["furl"]); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">原标志(logo)
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	               <img src="/Uploads/Admin/images/<?php echo ($art["fimage_c"]); ?>" style="width:200px;;border: 1px solid #ddd;padding:5px;" />
	            </div>
				
	        </div>
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">新彩色标志(logo)
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="file" id="image_c" data-parsley-id="4702" value="" onchange="javascript:setImagePreviewC();"><span><span style="font-size:12px;"> ! 建议上传图片大小 规格:200px(像素)*100px(像素)</span></span>
	            </div>
	        ...
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">新黑白标志(logo)
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="file" id="image_bw" data-parsley-id="4702" value="" onchange="javascript:setImagePreviewB();"><span><span style="font-size:12px;"> ! 建议上传图片大小 规格:200px(像素)*100px(像素)</span></span>
	            </div>
...
//     //
	...
	$('#image_c').blur(function(){
		if($('#image_c').val()){
			$('form').attr('enctype','multipart/form-data');
			$('#image_c').attr('name','fimage_c');

		}

	})
	$('#image_bw').blur(function(){
		if($('#image_bw').val()){
			$('form').attr('enctype','multipart/form-data');
			$('#image_bw').attr('name','fimage_bw');
