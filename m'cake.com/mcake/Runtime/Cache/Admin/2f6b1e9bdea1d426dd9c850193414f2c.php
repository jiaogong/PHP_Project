...
<div class="x_panel">
	...
	<div class="x_content">
	    <br>
	    <form action="<?php echo U(upload);?>" class="form1 form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" name="goods_insert" novalidate="" method="post">
				<input type="hidden" name="id" value="<?php echo ($art["id"]); ?>">
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">广告标题
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 300px;" class="form-control col-md-7 col-xs-12" required="required" id="title" name="title" data-parsley-id="4702" value="<?php echo ($art["title"]); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <img width="200px" src="/Uploads/Admin/images/<?php echo ($art["image"]); ?>" />
				</div>
			</div>
	         <div class="form-group">
	        ...
	        <div class="form-group">
	            ...
	            <label class="tishi_zong">
                       <div class="icheckbox_flat-green checked tishi" style="position: relative;margin-left: 10px;"><input name="prompt" value="<?php echo ($art["prompt"]); ?>" type="checkbox" checked="checked" class="flat tishi_text" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> 
                    </label>
	        </div>
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">广告位置
	            </label>
	            <input class="position_ad" type="hidden" name="position" value="<?php echo ($art["position"]); ?>">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	            	<select style="width:100px;height: 25px;font-size:18px;opacity: 0.7;" name="adtime">
	            		<option <?php if(($art["adtime"]) == "5"): ?>selected<?php endif; ?>>5</option>
	            		<option <?php if(($art["adtime"]) == "10"): ?>selected<?php endif; ?>>10</option>
	            		<option <?php if(($art["adtime"]) == "50"): ?>selected<?php endif; ?>>50</option>
	            		<option <?php if(($art["adtime"]) == "100"): ?>selected<?php endif; ?>>100</option>
	            		<option <?php if(($art["adtime"]) == "600"): ?>selected<?php endif; ?>>600</option>
	            		<option <?php if(($art["adtime"]) == "3600"): ?>selected<?php endif; ?>>3600</option>
	            	</select> 秒后 
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="number" style="width: 100px;height: 30px;" class="form-control col-md-7 col-xs-12" min='0' max="1" required="required" name="num" data-parsley-id="4702" value="<?php echo ($art["num"]); ?>">&nbsp;次<span></span>
	            </div>
	        </div>
