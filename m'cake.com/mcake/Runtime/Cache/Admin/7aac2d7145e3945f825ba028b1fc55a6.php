...
<div class="x_panel">
	...
	<div class="x_content">
	    ...
	    <form action="<?php echo U(insert);?>" class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" name="goods_insert" novalidate="" method="post" enctype="multipart/form-data">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 500px;" class="form-control col-md-7 col-xs-12" required="required" id="title" name="title" data-parsley-id="4702" value=""><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 500px;"  class="form-control col-md-7 col-xs-12" required="required" id="author" name="author" data-parsley-id="4702" value=""><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" style="width: 500px;" class="form-control col-md-7 col-xs-12" required="required" id="derivation" name="derivation" data-parsley-id="4702" value=""><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	        ...
	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">配图
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="file" id="image" name="image" data-parsley-id="4702" value="" onchange="javascript:setImagePreview();"><span></span>
	            </div>
		...
		<!-- 文本编辑区 开始 -->
			<script type="text/javascript" charset="utf-8" src="/mcake/Public/ueditor/ueditor.config.js"></script>
    		<script type="text/javascript" charset="utf-8" src="/mcake/Public/ueditor/ueditor.all.js"> </script>
			<script id="editor" type="text/plain" style="width:624px;height:400px;margin-left: 250px;"></script>
            ...
            <!-- 文本编辑区 结束 -->
	            ...
	            <!-- <div class="col-md-6 col-sm-6 col-xs-12">
	                <textarea style="border-radius: 3px;width: 500px;height: 300px;" rows="20"  name="content"  class="form-control col-md-7 col-xs-12" required="required" id="content" data-parsley-id="4702" ></textarea><span></span>
	            </div> -->
	        </div>
