...
<div class="/mcake/Public/Admin/production/col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
        ...
        <form action="<?php echo U(Admin/Ad/index);?>" method="get">
        <div class="x_content">
		...
		<div class="input-group">
			 <input value="<?php echo ($k); ?>" name="k" type="text" placeholder="搜索 输入广告标题关键字..." class="form-control">
			 <span class="input-group-btn">
	        	...
	        	<table class="table table-striped responsive-utilities jambo_table dataTable"  id="example" aria-describedby="example_info">
	              ...
	              <!-- 遍历数据库数据 -->
	          <?php if(is_array($ResArt)): foreach($ResArt as $key=>$Art): ?><tr class="pointer" style="border-top: 1px solid #ddd;padding: 6px;height:40px;background-color: #f9f9f9;">
		<td class="a-center">
			<div class="icheckbox_flat-green" style="position: relative;"><input type="checkbox" class="tableflat" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
             ...
             <td class="gname" style="text-overflow:ellipsis;height: 100px;"><div style="height: 55px;overflow: hidden;"><?php echo ($Art["title"]); ?></div><br/>
             </td>
             <td class="  "><div style="height: 55px;overflow: hidden;"><img width="150px"  src="/mcake/Uploads/Admin/images<?php echo ($Art["image"]); ?>"></div></td>
             <td class="  "><?php echo ($Art["prompt"]); ?></td>
             <td class="  "><?php echo ($Art["position"]); ?></td>
             <td class="  "><?php echo ($Art["adtime"]); ?></td>
             <td class=" "><?php echo ($Art["addtime"]); ?></td>
             <td class=" last "><ul class="nav navbar-right panel_toolbox">
                
                <li class="dropdown">
                    <a href="<?php echo U('Admin/Ad/edit',array('id'=>$Art['id']));?>">
                    <!-- 修改图标按钮 -->
                ...
                <!-- 删除图标按钮 -->
                	<a class="delete_but" ahref="<?php echo U('Admin/Ad/delete',array('id'=>$Art['id']));?>">
