...
<div class="x_panel">
	...
	<div class="x_content">
	    <br>
	    <form class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" novalidate="" action="<?php echo U('Admin/Type/update');?>" method="post">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
					<select class="form-control" name="pid">
                        ...
                        <?php if(is_array($types)): foreach($types as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php if(($info['pid']) == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>
                    </select>
	            </div>
	        </div>
