...
<body class="nav-md">
    ...
    <div class="x_content">
        ...
        <form data-parsley-validate="" id="demo-form" novalidate="">
            <label for="fullname" class="fa fa-cog"s><h2>CURL短信配置* :AJAX鼠标点击修改，鼠标离开自动保存</h2></label><br/>
   ...
   <form action="/mcake/index.php/Admin/Webconfig/messagea" method="post">
            测试：请输入接收者手机号:<input type="text" name="to" value="" placeholder="手机号">
                                     <input type="text" name="content" value="" placeholder="短信内容">
                                     <input type="submit" value="点击发送" class="btn btn-round btn-success">
    </form>
