...
<div class="x_panel">
	...
	<div class="x_content">
	    <br>
	    <form class="form-horizontal form-label-left" method="post" action="<?php echo U('Admin/Auser/insert');?>" data-parsley-validate="" id="demo-form2" novalidate="">
	        ...
	        <div class="form-group">
	        		...
	        		<?php if(is_array($groups)): foreach($groups as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></option><?php endforeach; endif; ?>
	        		</select><span></span>
	        </div>
	        <div class="form-group">
