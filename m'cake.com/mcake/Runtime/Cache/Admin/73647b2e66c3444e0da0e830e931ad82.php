    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div role="grid" class="dataTables_wrapper" id="example_wrapper">
	        	...
	        	<div class="clear"></div>
	        	<form action="<?php echo U('Admin/Rule/index');?>" method="get">
	        	<div id="example_length" class="dataTables_length">
			        ...
			        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search" style="width:450px">
                    	<a href="<?php echo U('Admin/Rule/add');?>" class="btn btn-success" style="display:block;float:right">添加权限</a>
	...
	<table id="example" class="table table-striped responsive-utilities jambo_table dataTable" aria-describedby="example_info">
		<thead>
		    <tr role="row" class="headings">
		        <th aria-label="Invoice : activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">ID </th>
		        <th aria-label="Invoice Date : activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">权限规则 </th>
		        <th aria-label="Order : activate to sort column ascending" style="width: 150px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">权限标识 </th>
		        <th aria-label="Order : activate to sort column ascending" style="width: 150px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">权限状态 </th>
		...
		<table>
		    ...
		    <!-- start project list -->
		        <table class="table table-striped projects">
		            <tbody>
		            <?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><tr class="pointer even">
	                        <td style="width:130px"><?php echo ($vo['id']); ?></td>
	                        <td style="width:260px"><?php echo ($vo['name']); ?></td>
	                        <td style="width:180px"><?php echo ($vo['title']); ?></td>
	                        <td style="width:200px"><?php echo (getrulestatus($vo['status'])); ?></td>
	                        <td id="del">
		                        <a class="btn btn-info btn-xs" href="<?php echo U('Admin/Rule/edit',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i> 修改 </a>
		                        <a class="btn btn-danger btn-xs" href="<?php echo U('Admin/Rule/delete',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除 </a>
	                        </td>
	    ...
	    <!--页码链接-->
    	<div id="example_paginate" class="dataTables_paginate paging_full_numbers" style="width:800px">
            <?php echo ($pages); ?>
        </div>
        <br><br><br>
	</table>
