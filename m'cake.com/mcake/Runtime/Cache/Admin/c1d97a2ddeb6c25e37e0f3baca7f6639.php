    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div role="grid" class="dataTables_wrapper" id="example_wrapper">
	        	...
	        	<div class="clear"></div>
	        	<form action="<?php echo U('Admin/Material/index');?>" method="get">
	        	<div id="example_length" class="dataTables_length">
	        		<label>显示 
	        		<select name="n" style="width: 100px;padding: 6px;" size="1" aria-controls="example">
		        		<option value="7" <?php if(($n) == "7"): ?>selected="selected"<?php endif; ?>>7</option>
	...
	<table id="example" class="table table-striped responsive-utilities jambo_table dataTable" aria-describedby="example_info">
		<thead>
		    <tr role="row" class="headings">
		        <th aria-label="Invoice : activate to sort column ascending" style="width: 94px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">ID </th>
		        <th aria-label="Invoice Date : activate to sort column ascending" style="width: 222px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">原料名称 </th>
		        <th aria-label="Order : activate to sort column ascending" style="width: 107px;" colspan="1" rowspan="1" aria-controls="example" tabindex="0" role="columnheader" class="sorting">来自国家 </th>
		...
		<table>
		    ...
		    <!-- start project list -->
		        <table class="table table-striped projects">
		            <tbody>
		            <?php if(is_array($materials)): foreach($materials as $key=>$vo): ?><tr class="pointer even">
	                        <td style="width:160px"><?php echo ($vo['id']); ?></td>
	                        <td style="width:380px"><?php echo ($vo['name']); ?></td>
	                       <td style="width:180px"><img src="/mcake/Public/<?php echo (getcountry($vo['country'])); ?>"></td>

	                        <td id="del">
		                        <a class="btn btn-info btn-xs" href="<?php echo U('Admin/Material/edit',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i> 修改 </a>
		                        <a class="btn btn-danger btn-xs" href="<?php echo U('Admin/Material/delete',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除 </a>
	                        </td>
