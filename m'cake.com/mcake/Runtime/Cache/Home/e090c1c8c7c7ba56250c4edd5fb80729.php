...
<title>我的订单 - MCAKE-一直都是巴黎的味道</title>
...
<div id="page_mainer">
    ...
    <div class="user_box">
        ...
        <div class="login_right mynews_box order_list">
           <form action="<?php echo U('Home/Members/order');?>" method="post">
            <ul class="Select_view all_order_nav" id="select_view">
                <li class="cur" stat=""><a href="<?php echo U('Home/Members/order');?>"><span>ALL</span><p>所有订单</p></a></li>
                <li stat="5"><a href="<?php echo U('Home/Members/order?status=5');?>">
                    <span>FINISH</span>
                    <p>已完成<small class="red">(<?php echo ($wancheng); ?>)</small></p>
                    </a>
                </li>
                <li stat="0"><a href="<?php echo U('Home/Members/order?status=0');?>">
                    <span>PAYMENT</span>
                    <p>新订单<small class="red">(<?php echo ($xindan); ?>)</small></p>
                    </a>
                </li>
                <li stat="4"><a href="<?php echo U('Home/Members/order?status=4');?>">
                    <span>AFTER RECEIPT</span>
                    <p>待收货<small class="red">(<?php echo ($daishou); ?>)</small></p>
                    </a>
                </li>
                <li stat="6"><a href="<?php echo U('Home/Members/order?status=6');?>">
                    <span>EVALUATION</span>
                    <p>无效订单<small class="red">(<?php echo ($quxiao); ?>)</small></p>
                    </a>
                </li>
            </ul>
            ...
            <ul>
                <li class="Search">
                    ...
                    <div>
                        <input type="text" name="sou" value="<?php echo ($sou); ?>" class="input_txt Search_icon" placeholder="订单号进行搜索"/>
                    </div>
                    <div class="toModify">
            ...
            <ul class="view_list all_list">
                ...
                <li class="cur">
                    ...
                    <ul class="order_th">
                        <li style="border:solid 1px #eee;width:80px;">订单号</li>
                        <li style="border:solid 1px #eee;width:200px;">收货地址</li>
                        <li style="border:solid 1px #eee;width:100px;">实付款（元）</li>
                        <li style="border:solid 1px #eee;width:100px;">购买时间</li>
                        <li style="border:solid 1px #eee;width:130px;">
                            <select name="fenlei" id="fenlei">
                                <option value="">所有订单</option>
                                <option value="0" <?php if(($fenlei) == "0"): ?>selected="selected"<?php endif; ?>>新订单</option>
                                <option value="1" <?php if(($fenlei) == "1"): ?>selected="selected"<?php endif; ?>>已付款</option>
                                <option value="2" <?php if(($fenlei) == "2"): ?>selected="selected"<?php endif; ?>>已包装</option>
                                <option value="3" <?php if(($fenlei) == "3"): ?>selected="selected"<?php endif; ?>>已生成发货单</option>
                                <option value="4" <?php if(($fenlei) == "4"): ?>selected="selected"<?php endif; ?>>已发货</option>
                                <option value="5" <?php if(($fenlei) == "5"): ?>selected="selected"<?php endif; ?>>已完成</option>
                                <option value="6" <?php if(($fenlei) == "6"): ?>selected="selected"<?php endif; ?>>无效订单</option>
                            </select>
                        </li>
                        <li style="border:solid 1px #eee;width:200px;">操作</li>
                    </ul>

                    <?php if(is_array($order)): foreach($order as $key=>$vo): ?><ul class="order_th">
                        <li style="border:solid 1px #eee;width:80px;"><?php echo ($vo['oid']); ?></li>
                        <li style="border:solid 1px #eee;width:200px;"><?php echo ($vo['address']); ?></li>
                        <li style="border:solid 1px #eee;width:100px;"><?php echo ($vo['total']); ?></li>
                        <li style="border:solid 1px #eee;width:100px;"><?php echo ($vo['addtime']); ?></li>
                        <li style="border:solid 1px #eee;width:130px;"><?php echo ($status[$vo['status']]); ?></li>
                        <li style="border:solid 1px #eee;width:200px;">
                            <a href="<?php echo U('Home/Members/order_detail');?>?oid=<?php echo ($vo['oid']); ?>">查看详情</a>
                            
                            <a style="margin-left:10px;" href="<?php echo U('Home/Members/delete');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                        </li>
...
<script type="text/javascript">
    ...
    $('#select_view li a').click(function(){
        $(this).children('p').css('border-bottom','3px solid #7b9196');
        // $(this).siblings('li p').css('');
        $(this).parents('li').siblings('li p').css('border-bottom','3px solid #d9e8eb');
    })
