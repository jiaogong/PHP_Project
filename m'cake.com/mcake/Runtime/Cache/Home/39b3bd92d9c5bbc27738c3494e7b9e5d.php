...
<form action="<?php echo U('Home/Orders/add');?>" method="post">
    ...
    <ul class="order_td">
        <li class="buy_car_list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr id="line_goods_11359">
                        <td class="pro_left">
                            <input name="shopcartid[]" value="<?php echo ($vo['id']); ?>" style="display:none">
                            <div class="buy_pro_img">
                                <img src="/mcake/Uploads/Admin/images/GoodsImg/<?php echo ($vo['path']); ?>" width="114" height="114" alt="<?php echo ($vo['cn_name']); ?>">
                            </div>
                            <div class="aleft">
                                <a href="#" class="Grey"><b><?php echo ($vo['en_name']); ?></b>
                                </a>
                                <?php echo ($vo['cn_name']); ?><br><br>
                            <div class="goods_promotion_11359"></div>
                            </div>
                        </td>
                        <td width="12%">
                            <div class="cake_num" style="width: 100%;">
                                <?php echo ($vo['weight']); ?>磅
                            </div>
                        </td>
                        <td width="11%">
                            <span class="goods_price"><?php echo ($vo['price']); ?>
                            </span>
                        <td width="10%"><div class="cake_num"><?php echo ($vo['num']); ?></div>
                        </td>
                        <td width="11%">
                            <span class="goods_total_price"><?php echo ($vo['subtotal']); ?>
                            </span>
                        </td>
                    </tr>                     
        ...
        <ul class="other_list">
            <li class="other_bs bs_em">
                <p style="width: auto;float: left;height: 40px;line-height: 50px;">
                    ...
                    <small img_link="/mcake/postsystem/docroot/images/system/20150413/2015041315353913962.jpg">赠送巧克力牌(可写祝福)</small>
                </p>
...
<li class="cur order_Total">
    ...
    <div class="order_Total_right">
        ...
        <div class="Total_bottom">
            ...
            <a href="<?php echo U('Home/ShopCart/Index');?>" class="link_line">返回购物车</a>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $('input[name=canju]').blur(function(){
        ...
        //获取购物车商品id
        var ids=[];
        $('input[name="shopcartid[]"]').each(function(){
           ids.push($(this).val());
        })
        //ajax发送参数
        $.get("<?php echo U('Home/Orders/edit');?>",{ids:ids},function(data){
            if(data){
