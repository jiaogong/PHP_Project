...
$(function () {
	...
	$.Alert_coupon = function (msg) {
        try {
         ...
         /*时间选择*/
		  var li_width=$(".datelist_box .datelist li").length*54;
          $(".datelist_box ul").css({"width":li_width});

          $(".delivery_time_ul .right_btn").click(function(){
			  if($(".datelist_box ul").css("left").replace(/[^-^0-9]/ig, "")<-li_width+8*54){
			    $(this).addClass("uncur");
			  }else{
				 $(".left_btn").removeClass("uncur");
				 $(".datelist_box ul").css({left:"-="+378})  
		      }
		  });

          $(".delivery_time_ul .left_btn").click(function(){
			  
			  if($(".datelist_box ul").css("left").replace(/[^-^0-9]/ig, "")>=0){
			   $(this).addClass("uncur");
			  }else{
		   ...
		   $("ul.datelist li").click(function(){
			...
			$("#selected_time").click(function(){
                if($("#select_t_2").val() < $("#select_t_3").val()){
