...
K.options = {
	...
	htmlTags : {
        ...
        style: ['type'],
        'canvas,button,em,span,div' : ['id', 'class', 'style', 'width', 'height'],
		...
		'a,map' : ['id', 'class', 'href', 'target', 'name', 'style'],
		embed : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', 'align', 'allowscriptaccess', 'style'],
		img : ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'title', 'align', 'style', 'usemap'],
		'p,ol,ul,li,blockquote,h1,h2,h3,h4,h5,h6' : [
			'id', 'class', 'align', 'style'
		],
		'br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del,pre,hr' : ['id', 'class', 'style'],
		iframe : ['id', 'class', 'src', 'frameborder', 'width', 'height', 'style'],
        area : ['coords', 'shape', 'target', 'href']
	},
