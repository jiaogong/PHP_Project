...
<title>我的积分 - MCAKE-一直都是巴黎的味道</title>
    ...
    <div class="user_box">
        ...
        <div class="user_left">
            ...
            <ul class="user_nav" style="width: 200px;">
                ...
                <li><a href="<?php echo U('Home/Members/order');?>">我的订单</a> <i id="i_id"></i></li>
            ...
            <ul class="Member_card_box">
                <li>
                    <p style="width:auto">
                        ...
                        <a href="javascript: void(0);" class="go get-points">如何获得积分？</a>
                        <a href="javascript: void(0);" class="go points-effect">积分的作用</a>
                    </p>
                </li>
                <li class="border_top">
                    <p><span>积分记录</span></p>
...
<div id="get-points-box" style="display: none;">
    <div style="width: 400px; height: 300px; padding:0 20px; line-height:23px;overflow-y:auto; overflow-x: hidden;word-wrap: break-word;word-break: normal;">
    <p>
<b>积分获取的方法？</b><br>
①注册得积分；（注册成功可获得100积分）<br>
②购物得积分；（购物完成可获得消费积分，按照会员每笔订单实际支付金额（优惠券、积分、现金卡、专项卡、红包抵扣部分不计入在内）赠送积分，每消费100元赠送25积分，按照此比例依次类推）<br>
③评论得积分；（有效订购的产品30天内可对其进行评价，评价通过审核即可获得50积分。若一笔订单包含N个产品，且评价皆通过审核，则最终可获得50N积分。若一笔订单中包含N个同款产品，仅可对商品评价一次，通过审核后，则最终可获得50积分）
    </p>
    </div>
</div>

<div id="points-effect-box" style="display: none;">
    <div style="width: 400px; height: 240px;overflow-y:auto; padding:0 20px; line-height: 18px; overflow-x: hidden;word-wrap: break-word;word-break: normal;">
    <pre>
<b>积分的作用？</b><br>
①积分当钱用：100积分=1元，积分可抵扣订单金额（不含环外费）；<br>
②积分兑换奖品（即将推出，敬请期待…）。<br>
<b>积分适用范围？</b><br>
