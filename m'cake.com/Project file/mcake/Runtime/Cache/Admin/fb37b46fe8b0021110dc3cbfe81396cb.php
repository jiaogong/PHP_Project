            ...
            <div role="grid" class="dataTables_wrapper" id="example_wrapper">
	        	...
	        	<table class="table table-striped responsive-utilities jambo_table dataTable" id="example" aria-describedby="example_info">
					...
					<tr>
                		...
                		<td><a href="#" title="点击查看货单订单详情表"><a href="/mcake/index.php/Admin/Orders/details/oid/<?php echo ($vo['id']); ?>"><?php echo ($vo['oid']); ?></a></td>
						...
						<td>
                			<a href="/mcake/index.php/Admin/Orders/pack/id/<?php echo ($vo['id']); ?>">生成包装</a>
                		</td>
                		<td>
                			<a href="/mcake/index.php/Admin/Orders/invoice/id/<?php echo ($vo['id']); ?>">生成发货单</a>
                		</td>
	                        <td>
	                        	 <ul class="nav navbar-right panel_toolbox">
					                ...
					                <li>
					                	<a href="/mcake/index.php/Admin/Orders/delete/id/<?php echo ($vo['id']); ?>" class="del">删除</a>
					                </li>
					            </ul>
	                        </td>
	                    </tr>
