    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <h2  class="title_right">打印订单：</h2>
                <table border="1" id='print1'>
                    <tr>
                        <td  width="106px">订单编号：</td>
                        <td  width="106px"><?php echo ($data['oid']); ?></td>
                        <td  width="106px">下单姓名：</td>
                        <td  width="106px"><?php echo ($data['linkman']); ?></td>
                        <td  width="106px">下单时间</td>
                        <td colspan="3"><?php echo ($data['addtime']); ?></td>
                    </tr>
                    <tr>
                        <td  width="106px">收件人姓名：</td>
                        <td  width="106px"><?php echo ($data['linkman']); ?></td>
                        <td  width="106px">收货时间:</td>
                        <td  width="106px"><?php echo ($data['sendtime']); ?></td>
                        <td  width="106px">付款方式：</td>
                        <td colspan="3">货到付款</td>   
                    </tr>
                    <tr>
                        <td>收货地址</td>
                        <td colspan="3"><?php echo ($data['address']); ?></td>
                        <td>是否开发票</td>
                        <?php if($invodata['status'] == 1): ?><td colspan="3">有发票</td> </tr>
                    <tr>
                        <td>发票类型：</td>
                        <td><?php echo ($type); ?></td>
                        <td>发票标题</td>
                        <td><?php echo ($invodata['title']); ?></td>
                        <td>发票内容</td>
                        <td><?php echo ($invodata['content']); ?></td>
                        <td>发票金额</td>
                        <td><?php echo ($invodata['total']); ?></td>   
                    </tr> 
                    <?php else: ?><td>无发票</td></tr><?php endif; ?><br/>
                ...
                <table border="1">
                    ...
                    <tr>
                            <td width="60px">
                             ...
                             <td  width="60px">
                                <?php echo ($detaildata['name']); ?>
                            </td >
                            <td  width="60px">
                                数量
                            </td>
                            <td  width="60px">
                                <?php echo ($detaildata['num']); ?>
                            </td>
                            <td  width="60px">
                                尺寸
                            </td>
                            <td  width="60px">
                                <?php echo ($detaildata['weight']); ?>磅
                            </td>
                            <td  width="60px">
                                商品价
                            </td>
                            <td  width="60px">
                                ￥&nbsp;<?php echo ($detaildata['price']); ?>元
                            </td>
                            <td  width="60px">
                                小计
                            </td>
