...
<div class="x_panel">
    ...
    <div class="x_content">
        <br>
        <form class="form-horizontal form-label-left" method="post" action="<?php echo U('Admin/Group/insert');?>" data-parsley-validate="" id="demo-form2" novalidate="">

            <div class="form-group">
                <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">管理组 <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" required="required" id="first-name" data-parsley-id="4702" name="title"><span></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$vo): ?><label class="">
                       <div class="icheckbox_flat-green " style="position: relative;margin-top:7px"><input name="name[]" value="<?php echo ($vo['id']); ?>" type="checkbox" class="flat" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> <span style="display:block;float:right;margin-top:8px">&nbsp;<?php echo ($vo['title']); ?></span>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div data-toggle="buttons" class="btn-group" id="gender">
                        <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-default">
                            <input type="radio" checked="" value='1' name="status" data-parsley-multiple="gender" data-parsley-id="5600"> &nbsp; 启用 &nbsp;
                        </label>
                        <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-default">
                            <input type="radio"  value='0' name="status" data-parsley-multiple="gender" data-parsley-id="5600"> &nbsp; 禁用 &nbsp; 
                        </label>
                    </div>
                </div>
            </div>
