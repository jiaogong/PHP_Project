...
<div class="/mcake/Public/Admin/production/col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
		...
		<div class="input-group">
			 <input value="<?php echo ($k); ?>" name="k" type="text" placeholder="搜索蛋糕名  中文或英文..." class="form-control">
	        	...
	        	<table class="table table-striped responsive-utilities jambo_table dataTable" id="example" aria-describedby="example_info">
	                <thead>
	                    <tr class="headings" role="row">
	                        ...
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 94px;" aria-label="Invoice : activate to sort column ascending">ID </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 222px;" aria-label="Invoice Date : activate to sort column ascending">名称 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 107px;" aria-label="Order : activate to sort column ascending">价格 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 114px;" aria-label="Bill to Name : activate to sort column ascending">状态 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 61px;" aria-label="Status : activate to sort column ascending">口味 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 75px;" aria-label="Amount : activate to sort column ascending">特别说明 </th>
	                        <th class="no-link last sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 63px;" aria-label="Action: activate to sort column ascending"><span class="nobr">操作</span></th>
	                    </tr>
	                </thead>
	              ...
	              <!-- 遍历数据库数据 -->
	          <?php if(is_array($ResGoods)): foreach($ResGoods as $key=>$goodsv): ?><tr class="pointer" style="border-top: 1px solid #ddd;padding: 6px;height:120px;vertical-align: center;text-align:center;background-color: #f9f9f9;">
		<td class="a-center">
			<div class="icheckbox_flat-green" style="position: relative;"><input type="checkbox" class="tableflat" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
             ...
             <td class="gid"><?php echo ($goodsv["id"]); ?></td>
             <td class="gname"><?php echo ($goodsv["en_gname"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($goodsv["cn_gname"]); ?><br/><div ><img style="border:1px solid #ccc;border-radius:4px;padding:5px;background: white;opacity:0.9;" src="/mcake/Uploads/Admin/images/GoodsImg/<?php
 $arr=explode(',',$goodsv['picname']); $arr[0]; echo (substr($goodsv['addtime'],0,8)."/"."s_".$arr[0]);?>" ></img></div>
             </td>
             <td class="  "><?php echo ($goodsv["price"]); ?></td>
             <td class="  "><?php echo ($goodsv["status"]); ?></td>
             <td class="  "><?php echo ($goodsv["feeling"]); ?></td>
             <td class="a-right a-right  " ><div style="width: 140px;overflow: hidden;"><?php echo ($goodsv["state"]); ?></div></td>
             <td class=" last "><ul class="nav navbar-right panel_toolbox">
                
                <li class="dropdown">
                    <a href="<?php echo U('Admin/Goods/edit',array('id'=>$goodsv['id']));?>">
                    <!-- 修改图标按钮 -->
                ...
                <!-- 删除图标按钮 -->
                	<a class="delete_but" ahref="<?php echo U('Admin/Goods/delete',array('id'=>$goodsv['id']));?>">
           ...
           <div class="avatar-body" style="height: 200px;">
               ...
               <div style="margin-left: 60px;margin-top: 30px">
	               <div style="width: 100px;float:left;margin-right: 30px;">
					<a href="" class="del_buta btn btn-primary btn-block avatar-save"  type="submit">确认删除</a>
					</div>
					<div style="width: 100px;">
					<button class="btn btn-primary btn-block avatar-save" id="cancel_but" type="submit">取消</button>
					</div>
               </div>
               </div>
           </div>
