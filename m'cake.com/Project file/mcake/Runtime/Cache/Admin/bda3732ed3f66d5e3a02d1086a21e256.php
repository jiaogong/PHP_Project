    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div role="grid" class="dataTables_wrapper" id="example_wrapper">
	        	...
	        	<div class="clear"></div>
	        	<form action="<?php echo U('Admin/Auser/index');?>" method="get">
	        	<div id="example_length" class="dataTables_length">
	        		<label>显示 <select name="xianshi" style="width: 56px;height:30px;padding: 6px;" size="1" aria-controls="example">
	        		<option value="5" <?php if(($xianshi) == "5"): ?>selected="selected"<?php endif; ?>>5</option>
	        	...
	        	<table class="table table-striped responsive-utilities jambo_table dataTable" id="example" aria-describedby="example_info">
	                <thead>
	                    <tr class="headings" role="row">
	                        ...
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Invoice Date : activate to sort column ascending">用户名 </th>
	                        ...
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 130px;" aria-label="Status : activate to sort column ascending">邮箱</th>
	                        ...
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 110px;" aria-label="Amount : activate to sort column ascending">组别</th>
	                        ...
	                        <th class="no-link last sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width:120px;" aria-label="Action: activate to sort column ascending"><span class="nobr">操作</span></th>
	                    </tr>
	                </thead>
	            	<tbody role="alert" aria-live="polite" aria-relevant="all">
	            		<?php if(is_array($ausers)): foreach($ausers as $key=>$vo): ?><tr class="pointer even">
	                        <td class="  "><?php echo ($vo['id']); ?></td>
	                        <td class="  "><?php echo ($vo['ausername']); ?></td>
	                        <td class="  "><?php echo ($asex[$vo['asex']]); ?></td>
	                        <td class="  "><?php echo ($vo['aemail']); ?></td>
	                        <td class="  "><?php echo ($vo['aphone']); ?></td>
	                        <td class="  "><?php echo ($group_id[$vo['group_id']]); ?></td>
	                        <td class="  "><?php echo ($vo['addtime']); ?></td>
	                        <td>
	                        	 <ul class="nav navbar-right panel_toolbox">
					                
					                <li>
					                    <a href="<?php echo U('Admin/Auser/edit',array('id'=>$vo['id']));?>"><i class="fa fa-wrench"></i></a>
					                </li>
					                <li>
					                	<a href="<?php echo U('Admin/Auser/delete',array('id'=>$vo['id']));?>" class="del"><i class="fa fa-close"></i></a>
					                </li>
					                <li>
					                	<a href="<?php echo U('Admin/Auser/editpass',array('id'=>$vo['id']));?>">修改密码</a>
					                </li>
					            </ul>
	                        </td>
...
<script type="text/javascript">
	...
	$('.pointer td:nth-child(2)').dblclick(function() {
		...
		input.blur(function(){
			...
			//发送ajax
			$.post("<?php echo U('Admin/Auser/update');?>", {id:id,ausername:ausername}, function(data){
				if(data == 0){
					td.html(ausername);
					alert('更新成功!')
				}else{
