...
<div class="x_panel">
    <div class="x_title">
        <h2>修改会员信息 <small>请认真填写</small></h2>
        <div class="clearfix"></div>
    </div>
	<div class="x_content">
	    <br>
	    <form class="form-horizontal form-label-left" method="post" action="<?php echo U('Admin/User/update');?>" data-parsley-validate="" id="demo-form2" novalidate="">

	        <div class="form-group">
	            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">会员账号 <span class="required">*</span>
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" class="form-control col-md-7 col-xs-12" required="required" id="first-name" data-parsley-id="4702" name="usercount" value="<?php echo ($users['usercount']); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" class="form-control col-md-7 col-xs-12" required="required" id="first-name" data-parsley-id="4702" name="name" value="<?php echo ($users['name']); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="middle-name">邮编</label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" name="code" class="form-control col-md-7 col-xs-12" id="middle-name" data-parsley-id="0283" value="<?php echo ($users['code']); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <div data-toggle="buttons" class="btn-group" id="gender">
	                    <?php if($users['sex'] == 1 ): ?><label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-primary active">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" required="required" class="date-picker form-control col-md-7 col-xs-12" id="birthday" data-parsley-id="3087" name="email" value="<?php echo ($users['email']); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <input type="text" required="required" class="date-picker form-control col-md-7 col-xs-12" id="birthday" data-parsley-id="3087" name="phone" value="<?php echo ($users['phone']); ?>"><span></span>
	            </div>
	        </div>
	        <div class="form-group">
	        	<label class="control-label col-md-3 col-sm-3 col-xs-12">状态</label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	                <div data-toggle="buttons" class="btn-group" id="state">
	                	<?php if($users['state'] == 1 ): ?><label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-primary active">
	                        	<input type="radio" checked="" value='1' name="state" data-parsley-multiple="gender" data-parsley-id="5600"> &nbsp; 启用 &nbsp;
		                    </label>
		                    <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-default">
		                        <input type="radio"  value='0' name="state" data-parsley-multiple="gender" data-parsley-id="5600"> &nbsp; 禁用 &nbsp; 
		                    </label>
	                	<?php else: ?>
		                    <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-default">
		                        <input type="radio" checked="" value='1' name="state" data-parsley-multiple="gender" data-parsley-id="5600"> &nbsp; 启用 &nbsp;
