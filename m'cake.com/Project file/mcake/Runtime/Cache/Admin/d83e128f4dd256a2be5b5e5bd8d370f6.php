...
<div class="/mcake/Public/Admin/production/col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
		...
		<div class="input-group">
			 <input value="<?php echo ($k); ?>" name="k" type="text" placeholder="搜索 输入文章标题关键字..." class="form-control">
	        	...
	        	<table class="table table-striped responsive-utilities jambo_table dataTable"  id="example" aria-describedby="example_info">
	                <thead>
	                    <tr class="headings" role="row">
	                        ...
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 147px;" aria-label="Invoice Date : activate to sort column ascending">&nbsp;&nbsp;标题 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 97px;" aria-label="Order : activate to sort column ascending">&nbsp;作者 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 85px;" aria-label="Bill to Name : activate to sort column ascending">添加时间 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Status : activate to sort column ascending">出处 </th>
	                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 75px;text-align: center;" aria-label="Amount : activate to sort column ascending">阅读量 </th>
		...
		<td class="a-center">
			<div class="icheckbox_flat-green" style="position: relative;"><input type="checkbox" class="tableflat" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
             ...
             <td class="gid" ><?php echo ($Art["id"]); ?></td>
             <td class="gname" style="text-overflow:ellipsis;height: 60px;"><div style="height: 55px;overflow: hidden;"><?php echo ($Art["title"]); ?></div><br/>
             </td>
             <td class="  "><div style="height: 55px;overflow: hidden;"><?php echo ($Art["author"]); ?></div></td>
             <td class="  "><?php echo ($Art["addtime"]); ?></td>
             <td class="  " style="text-overflow:ellipsis;height: 60px;"><div style="height: 55px;overflow: hidden;"><?php echo ($Art["derivation"]); ?></div></td>
             <td class="a-right a-right  " style="text-align: center;" ><?php echo ($Art["read_num"]); ?></td>
             <td class=" last "><ul class="nav navbar-right panel_toolbox">
                
                <li class="dropdown">
                    <a href="<?php echo U('Admin/Article/edit',array('id'=>$Art['id']));?>">
                    <!-- 修改图标按钮 -->
                ...
                <!-- 删除图标按钮 -->
                	<a class="delete_but" ahref="<?php echo U('Admin/Article/delete',array('id'=>$Art['id']));?>">
