...
<html lang="{{ config('app.locale') }}">
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" method="post" action="{{ route('admin_homeShow_add_data') }}" enctype="multipart/form-data">
				{{ csrf_field() }}
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea placeholder="请输入内容" name="subheading" class="layui-textarea"></textarea>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<select name="type">
							...
							<option value="1" selected="">1:首页顶部6小轮播图</option>
							<option value="2">2:首页顶部6小轮播图背景</option>
							<option value="3">3:首页中间2中图</option>
							<option value="4">4:首页中下4小图</option>
							<option value="5">5:首页下图大图</option>
						</select>
						</div>
					</div>
				</div>
